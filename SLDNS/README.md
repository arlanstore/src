# SLDNS
SSH OVER DNS create by ARLANSTORE 
* Link Script Repo SlowDNS dari arlanstore
```html
https://raw.githubusercontent.com/arlanstore/izinvps/ipuk/SLDNS
```

Script Auto Installer SlowDNS
```html
wget -q -O /usr/bin/install-sldns "https://raw.githubusercontent.com/arlanstore/izinvps/ipuk/SLDNS/install-sldns"
